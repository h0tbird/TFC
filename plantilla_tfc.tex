...
La complejidad de la gestión administrativa incrementa linealmente \emph{O(n)} con el número de servidores pero lo hace de forma no lineal \emph{O(n\^{}2)} con la diversidad de sistemas administrados.
