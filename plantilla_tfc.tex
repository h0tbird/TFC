...
La plataforma de arranque o \emph{bootstrapping} esta compuesta por 6 contenedores de \emph{Docker} conectados entre sí mediante un bridge que a su vez los conecta con la red física. En el siguiente esquema se representan los 6 contenedores, las interfaces de red y los sistemas físicos que queremos aprovisionar y que constituirán la plataforma de explotación:
...
En la tabla que sigue se detallan los siguientes conceptos:

\begin{itemize}
  \item \textbf{Imagen:} Nombre público de la imagen que se utiliza como base sobre la que instanciar el contenedor.
