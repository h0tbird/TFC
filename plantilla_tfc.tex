...
Para realizar la automatización se ha creado una plataforma paralela de \emph{bootstrapping} compuesta por cuatro elementos funcionales que han sido encapsulados en contenedores de \emph{Docker}. El siguiente esquema simplificado conecta con el esquema de plataforma:

\begin{figure}[h]
  \centering
    \includegraphics[scale=1]{bootstrapping}
