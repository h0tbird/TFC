...
\begin{figure}[h]
  \centering
    \includegraphics[scale=1]{arranque}
      \caption{Arranque.}
\end{figure}
...
Puesto que no es lo mismo recuperar el software de arranque desde un MBR que desde un equipo remoto, el \emph{`firmware'} que quiera ejecutar \emph{`PXELinux.0'}, va a tener que implementar una solución específica. A continuación veremos las tecnologías que lo hacen posible.
