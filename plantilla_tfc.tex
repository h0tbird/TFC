...
El proyecto termina con una guia de instalación de la plataforma de arranque para que el lector pueda desplegar en su propia infraestructura una plataforma de explotación.
\end{resum}
...
El último paso antes de arrancar los equipos físicos via \emph{PXE}, consiste en realizar las adaptaciones necesarias sobre los ficheros de arranque de \emph{'pxelinux'} y los ficheros de instalación de \emph{'kickstart'}.
