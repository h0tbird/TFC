...
Más adelante, en el capítulo 4, veremos cómo instalar la plataforma de arranque. En este capítulo se supone que la plataforma ya ha sido instalada de manera que podemos explorar su estado utilizando varios comandos que nos darán visión sobre los contenedores y los distintos elementos de red.
...
El comando \emph{'brctl show'} sirve para mostrar el estado de los \emph{'bridges'} así como de las \emph{'interfaces'} que tienen vinculadas:\\
...
A continuación veremos cada uno de los seis contenedores usados en la plataforma de arranque.
...
Este contenedor ejecuta un servidor web \emph{Apache} que se utiliza como servidor de ficheros estáticos.
Principalmente repositorios \emph{YUM}, la imagen del instalador \emph{Anaconda}, la imagen de disco del sistema operativo \emph{CoreOS} y ficheros \emph{kickstart}.
...
Relación de ficheros que influyen sobre el comportamiento de \emph{data01}:
